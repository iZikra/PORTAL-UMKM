...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                {{-- [FIXED] Menambahkan link ke admin dashboard pada logo --}}
            ...
            <!-- Page Heading -->
            {{-- [FIXED] Menggunakan @hasSection dan @yield untuk header --}}
            @hasSection('header')
            ...
            <!-- Page Content -->
            {{-- [FIXED] Menggunakan @yield dan class animasi yang benar --}}
