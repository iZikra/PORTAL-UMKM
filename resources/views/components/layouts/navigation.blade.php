        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        {{-- Link untuk semua user yang sudah login --}}
                        ...
                        @else
                            {{-- Link Khusus User Biasa --}}
                            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                                {{ __('Dashboard') }}
                            </x-nav-link>
                        @endif
                        
                        {{-- Link yang sama untuk Admin dan User Biasa --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                <x-responsive-nav-link :href="route('knowledge-base.public')" :active="request()->routeIs('knowledge-base.public')">
                    {{ __('Basis Pengetahuan') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('faq.public')" :active="request()->routeIs('faq.public')">
                    {{ __('FAQ') }}
                </x-responsive-nav-link>
            @endauth
        </div>
