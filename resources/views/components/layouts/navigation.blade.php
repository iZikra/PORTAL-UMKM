        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->check() ? (auth()->user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')) : route('home') }}" class="text-xl font-bold text-gray-800 dark:text-gray-200">
                        Portal UMKM
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        ...
                        @else
                            ...
                            {{-- PERBAIKAN: Menambahkan link FAQ untuk User --}}
        ...
        @auth
            <div class="pt-2 pb-3 space-y-1">
                ...
                @else
                    ...
                    {{-- PERBAIKAN: Menambahkan link FAQ untuk User (Mobile) --}}
