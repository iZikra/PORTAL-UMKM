                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                @auth
                                    {{-- Link Dashboard (berbeda untuk admin dan user) --}}
                                    ...
                                    {{-- Link ini sekarang muncul untuk semua user yang login --}}
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            @else
                                ...
                                <a href="{{ route('register') }}" class="ml-4 text-sm font-medium text-gray-700 dark:text-gray-400 hover:underline">Register</a>
                            @endguest
                        </div>
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        @auth
                            @if(Auth::user()->role === 'admin')
                                ...
                                <x-responsive-nav-link :href="route('admin.pengaduan.index')" :active="request()->routeIs('admin.pengaduan.index')">{{ __('Kelola Pengaduan') }}</x-responsive-nav-link>
                            @else
                                <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">{{ __('Dashboard') }}</x-responsive-nav-link>
                            @endif

                            {{-- Link ini sekarang muncul untuk semua user yang login di mobile --}}
