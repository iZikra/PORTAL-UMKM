            ...
            <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                {{-- PERBAIKAN 1: Arahkan logo ke dashboard yang sesuai dengan role --}}
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                {{-- PERBAIKAN 2: Tampilkan menu navigasi berdasarkan role pengguna --}}
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            @auth
                                {{-- This will be displayed if the user is logged in --}}
                            ...
                            @else
                                {{-- This will be displayed for guests (not logged in) --}}
                                ...
                                @endif
                            {{-- PERBAIKAN 3: Mengganti @endguest dengan @endauth yang benar --}}
                            @endauth
                        </div>
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        {{-- PERBAIKAN 4: Tampilkan menu navigasi mobile berdasarkan role --}}
                        @if (Auth::user()->role === 'admin')
