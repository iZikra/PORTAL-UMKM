        ...
        <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('admin.dashboard') }}" class="flex items-center">
                                ...
                                {{-- PERBAIKAN: Menghapus span duplikat dari sini --}}
                            </a>
                        </div>
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('admin.knowledge-base.index')" :active="request()->routeIs('admin.knowledge-base.index*')">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('admin.knowledge-base.index')" :active="request()->routeIs('admin.knowledge-base.index*')">
                        {{ __('Basis Pengetahuan') }}
                    </x-responsive-nav-link>
