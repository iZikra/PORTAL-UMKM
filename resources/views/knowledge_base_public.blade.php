        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 lg:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- [KODE BARU] Menambahkan Judul dan Deskripsi seperti halaman FAQ --}}
                    ...
                    {{-- [KODE BARU] Menggunakan struktur akordeon dengan Alpine.js --}}
                    <div x-data="{ open: null }" class="space-y-4">
                        @php
                            // Konten statis yang akan selalu ditampilkan
                            $staticArticles = [
                            ...
                            // Mengubah artikel dinamis dari database menjadi format yang sama
                            $dynamicArticles = isset($articles) ? $articles->map(function ($article) {
                                return ['id' => 'd' . $article->id, 'kategori' => $article->kategori, 'judul' => $article->judul, 'konten' => $article->konten];
                            })->all() : [];
                            
                            // Menggabungkan kedua jenis artikel
                            $allArticles = array_merge($staticArticles, $dynamicArticles);
                        @endphp
