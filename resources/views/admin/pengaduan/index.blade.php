            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4 mb-6">
                        ...
                        {{-- Dropdown Hover dengan area yang lebih besar --}}
                        <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative inline-block text-left w-full md:w-auto">
                            {{-- Tombol Pemicu --}}
                            <div>
                                <button type="button" class="inline-flex justify-between w-full rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 focus:ring-indigo-500">
                                    <span>
                            ...
                            {{-- [PERBAIKAN] Menu Dropdown dengan transisi lebih smooth --}}
                            <div 
                                x-show="open" 
                                ...
                                style="display: none;">
                                <div class="py-1">
                                    <a href="{{ route('admin.pengaduan.index') }}" class="text-gray-700 dark:text-gray-200 block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">Semua</a>
                                    <a href="{{ route('admin.pengaduan.index', ['status' => 'Baru']) }}" class="text-gray-700 dark:text-gray-200 block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">Baru</a>
                                    <a href="{{ route('admin.pengaduan.index', ['status' => 'Diproses']) }}" class="text-gray-700 dark:text-gray-200 block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">Diproses</a>
                                    <a href="{{ route('admin.pengaduan.index', ['status' => 'Selesai']) }}" class="text-gray-700 dark:text-gray-200 block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">Selesai</a>
                                    <a href="{{ route('admin.pengaduan.index', ['status' => 'Ditolak']) }}" class="text-gray-700 dark:text-gray-200 block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">Ditolak</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($pengaduans as $key => $pengaduan)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $pengaduan->user->nama_usaha ?? $pengaduan->user->name }}</td>
