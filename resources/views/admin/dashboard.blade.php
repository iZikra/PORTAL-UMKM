<x-admin-layout>
    <x-slot name="header">
        ...
        {{-- Tambahkan div kosong agar justify-between berfungsi --}}
        <div></div> 
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 mb-6">
                ...
                <a href="{{ route('admin.pengaduan.index') }}" class="bg-orange-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
