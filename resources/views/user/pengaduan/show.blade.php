        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100 space-y-6">
                    ...
                    {{-- Bagian Informasi Pelapor dan Detail Laporan --}}
                    <div class="mb-6">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div class="space-y-4 mt-4">
                            @forelse (($pengaduan->tanggapans ?? []) as $tanggapan)
                                <div class="{{ $tanggapan->user->role == 'admin' ? 'bg-gray-50 dark:bg-gray-700/50' : 'bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800' }} p-4 rounded-lg">
                    ...
                    {{-- FITUR BARU: Form Balasan untuk User --}}
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
