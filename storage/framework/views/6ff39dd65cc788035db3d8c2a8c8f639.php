    ...
    <div class="container relative mx-auto">
        <div class="flex flex-wrap items-center">
            <div class="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
                ...
                <div class="mt-8">
                    <a href="<?php echo e(route('register')); ?>" class="bg-indigo-500 text-white hover:bg-indigo-600 px-8 py-3 rounded-full text-lg font-semibold transition duration-300">Daftar Sekarang</a>
                </div>
            </div>
        </div>
    </div>
