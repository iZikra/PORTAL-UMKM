...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="underline font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-200">
                    Daftar di sini
                </a>
            </p>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\GF 63\proyek-multi-auth\resources\views/auth/login.blade.php ENDPATH**/ ?>