    ...
    <header class="flex items-center space-x-3 border-b dark:border-gray-700 pb-4">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Setelah akun Anda dihapus, semua sumber daya dan datanya akan dihapus secara permanen.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                <?php echo e(__('Apakah Anda yakin ingin menghapus akun Anda?')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Setelah akun Anda dihapus, semua data akan dihapus permanen. Silakan masukkan kata sandi Anda untuk mengonfirmasi.')); ?>
...
<?php endif; ?>
</section><?php /**PATH C:\Users\GF 63\proyek-multi-auth\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>