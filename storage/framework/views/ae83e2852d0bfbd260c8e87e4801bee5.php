        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(auth()->check() ? (auth()->user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')) : route('home')); ?>" class="text-xl font-bold text-gray-800 dark:text-gray-200">
                        Portal UMKM
                    </a>
                </div>
